            ...
            (n.prototype.draw = function () {
                ...
                for (var a = z.length - 1; a > this.stackPos; a--) {
                    ...
                    e < g.proximity &&
                        ...
                        g.curvedLines
                            ? s.quadraticCurveTo(Math.max(b.position.x, b.position.x), Math.min(b.position.y, b.position.y), b.position.x + b.parallaxOffsetX, b.position.y + b.parallaxOffsetY)
